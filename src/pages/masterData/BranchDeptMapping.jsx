...
const BranchDeptMapping = () => {
  ...
  const { canWrite: acmCanWrite } = useAcmScope();
  const allowWrite = canEdit && acmCanWrite;
        ...
        <div className="mb-8">
          ...
          <p className="text-sm text-gray-600 mt-1">
            {t('branchDeptMapping.subtitle', {
              defaultValue: 'Map departments to branches (tblBR_DEPT). A department can belong to multiple branches.',
            })}
          </p>
        </div>
