...
export default function Header() {
  ...
  const pathTitleMap = {
    ...
    "/workorder-management": { title: t('workorderManagement.title'), subtitle: t('workorderManagement.subtitle') },
    "/maintenance-approval": { title: t('maintenanceApproval.title'), subtitle: t('maintenanceApproval.subtitle') },
    "/supervisor-approval": { title: t('maintenanceSupervisor.title'), subtitle: t('maintenanceSupervisor.subtitle') },
    "/report-breakdown": { title: t('reportsBreakdown.title'), subtitle: t('reportsBreakdown.subtitle') },
